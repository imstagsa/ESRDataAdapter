...
import org.apache.log4j.Logger;
 ...
 public class ESRQueryExecuterExtensionRegistry implements ExtensionsRegistryFactory {
    
    private static Logger logger = Logger.getLogger(ESRQueryExecuterExtensionRegistry.class);
		...
		public <T> List<T> getExtensions(Class<T> extensionType) {
			if (JRQueryExecuterFactoryBundle.class.equals(extensionType)) {
				...
				return (List<T>) Collections
						.singletonList(ESRQueryExecuterFactoryBundle
								.getInstance());
			}
			return null;
		}
