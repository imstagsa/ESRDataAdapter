...
public class ESRQueryDesigner extends QueryDesigner {
	/* Text area where enter the query */
	protected StyledText queryTextArea;
	
	private static Logger logger = Logger.getLogger(ESRQueryDesigner.class);
	...
	protected void queryTextAreaModified() {
		logger.debug("ESJQueryDesigner.queryTextAreaModified");
