...
public class ESRQueryExecuterFactory implements QueryExecuterFactory {
	...
	public JRQueryExecuter createQueryExecuter(JRDataset dataset,
			...
			throws JRException {
		return new ESRQueryExecuter(DefaultJasperReportsContext.getInstance(), dataset, parameters);
	};
	...
	public JRQueryExecuter createQueryExecuter(
			...
			Map<String, ? extends JRValueParameter> parameters)
			throws JRException {
		return new ESRQueryExecuter(jasperReportsContext, dataset, parameters);
	}
