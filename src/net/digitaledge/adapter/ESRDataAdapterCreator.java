...
import net.digitaledge.ESRDataAdapterDescriptor;
...
public class ESRDataAdapterCreator implements IDataAdapterCreator {

	@Override
	public DataAdapterDescriptor buildFromXML(Document docXML) {
		ESRAdapterImplementation result = new ESRAdapterImplementation();
		...
		ESRDataAdapterDescriptor desc = new ESRDataAdapterDescriptor();
	...
	@Override
	public String getID() {
		return "net.digitaledge.adapter.ESRDataAdapterCreator";
	}
