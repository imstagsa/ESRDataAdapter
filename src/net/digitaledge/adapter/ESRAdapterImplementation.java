...
public class ESRAdapterImplementation extends AbstractDataAdapter implements ESRAdapter {
	...
	Logger logger = Logger.getLogger(ESRAdapterImplementation.class);
    
    public ESRAdapterImplementation() {
    	super();
